  ...
  FROM
    (
      ...
      FROM (
        ...
        WHERE threads.Thread_ID = sms_type0_stage1.thread_id
              AND sms_type0_stage0.record_offset = sms_type0_stage1.record_offset
      )
    )
...
SELECT DISTINCT
  ...
  coalesce(a.timestamp3, b.timestamp3, "<not parsed>")    AS "sent/recieved",
